...
<div style="display: flex; justify-content: center; background-color: black; height: 100px;">
  <h1 style=" color: red;">UPDATE MACHINEGUN</h1>
</div>
<div class="mainDiv">
  <%
    Machineguns machinegun = (Machineguns) request.getSession().getAttribute("machinegun");
  %>
  <form action="/machineupdate" method="post" style=" height: 1000px; background-color: black; color: red; ">
    <div>
      <label for="exampleInputId" class="form-label" >ID</label>
      <input type="hidden" class="form-control" id="exampleInputId" aria-describedby="emailHelp" value="<%=machinegun.getId()%>" name="id">
    </div>
