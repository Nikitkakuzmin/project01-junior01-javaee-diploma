...
<div class="el infoDiv" style="border: 0px solid  rgb(212, 211, 211); width: 1900px; height:400px; margin-top: 50px;
    ...
    <form action="/regist" method="post">
        <div style=" display: flex; height: 70px; background-color: red ; color: black;border-radius: 2%;">
            <h2 style="margin-left: 20px;">Registration Page</h2>
        </div>
        <div class="mb-3" style= "display:flex;  height: 50px; width: 1900px; margin-top: 20px;">
            <div style="display:flex;">
                <label for="exampleInputEmail1" class="form-label" style="font-size: 30px; margin-top: 5px;
                    margin-left: 20px; color: red">Email:</label>
            </div>
            <div>
        ...
        <div class="mb-3" style= "display:flex;  height: 50px; width: 1900px; margin-top: 30px;">
            <div>
                <label for="exampleInputPassword1" class="form-label" style="font-size: 30px; margin-top: 5px; color: red;
        ...
        <button type="submit" class="btn btn-primary" style="height: 40px; width: 130px; margin-left: 25px; color: rgb(0,0,0);
            ...
            border-radius: 5%; font-size: 15px; border: 0px;">Regist</button>
    </form>
</div>
</div>
