...
<div style="display: flex; justify-content: center; background-color: black; height: 100px;">
  <h1 style=" color: red;">UPDATE PISTOL</h1>
</div>
<div class="mainDiv">
  <%
    Pistols pistol = (Pistols) request.getSession().getAttribute("pistol");
  %>
  <form action="/pistolupdate" method="post" style=" height: 1000px; background-color: black; color: red; ">
    <div>
      <label for="exampleInputId" class="form-label" >ID</label>
      <input type="hidden" class="form-control" id="exampleInputId" aria-describedby="emailHelp" value="<%=pistol.getId()%>" name="id">
    </div>
