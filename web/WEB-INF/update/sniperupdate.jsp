...
<div style="display: flex; justify-content: center; background-color: black; height: 100px;">
    <h1 style=" color: red;">UPDATE SNIPER RIFLE</h1>
</div>
<div class="mainDiv">
    <%
        Sniperrifles sniperrifle = (Sniperrifles) request.getSession().getAttribute("sniperrifle");
    %>
    <form action="/sniperupdate" method="post" style=" height: 1000px; background-color: black; color: red; ">
        <div>
            <label for="exampleInputId" class="form-label" >ID</label>
            <input type="hidden" class="form-control" id="exampleInputId" aria-describedby="emailHelp" value="<%=sniperrifle.getId()%>" name="id">
        </div>
