...
<html>
<head>
    <title>addSniperrifle</title>
</head>
<body>
<div style="display: flex; justify-content: center; background-color: black; height: 100px;">
    <h1 style=" color: red;">ADD SNIPER RIFLE</h1>
</div>
<form action="/addsniper" method="post" style=" height: 1000px; background-color: black; color: red; ">
